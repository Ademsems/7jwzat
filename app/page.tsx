    ...
    <div className="page-enter">
      ...
      >
        ...
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none overflow-hidden">
          <div style={{ position: "absolute", top: "10%", left: "8%",  width: 420, height: 420, borderRadius: "50%", background: "radial-gradient(circle, rgba(16,185,129,0.1) 0%, transparent 70%)", filter: "blur(40px)", animation: "orb1 14s ease-in-out infinite" }} />
          <div style={{ position: "absolute", top: "55%", right: "6%", width: 340, height: 340, borderRadius: "50%", background: "radial-gradient(circle, rgba(16,185,129,0.08) 0%, transparent 70%)", filter: "blur(40px)", animation: "orb2 18s ease-in-out infinite" }} />
          <div style={{ position: "absolute", bottom: "8%", left: "30%",width: 280, height: 280, borderRadius: "50%", background: "radial-gradient(circle, rgba(16,185,129,0.07) 0%, transparent 70%)", filter: "blur(30px)", animation: "orb3 22s ease-in-out infinite" }} />
          <div style={{ position: "absolute", top: "30%", right: "25%",width: 200, height: 200, borderRadius: "50%", background: "radial-gradient(circle, rgba(52,211,153,0.07) 0%, transparent 70%)", filter: "blur(24px)", animation: "orb4 12s ease-in-out infinite" }} />
        </div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 pt-24 pb-28 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-tight mb-6">
            <span className="hero-line-1 block">Your booking system.</span>
            <span className="hero-line-2 block text-emerald-400">No coding. No setup.</span>
          </h1>
          ...
          <p className="hero-proof mt-10 text-sm text-slate-500">
            Used by businesses in UAE, Saudi Arabia &amp; Jordan
          </p>

          {/* Mock booking UI */}
          <div className="hero-mock mt-16 max-w-sm mx-auto bg-white/5 border border-white/10 rounded-2xl p-6 text-left backdrop-blur-sm hover:bg-white/8 transition-colors duration-300">
            <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-4">Customer booking page</p>
            <div className="space-y-3">
              <div className="bg-white/10 rounded-lg px-4 py-3 text-sm text-slate-200 font-medium hover:bg-white/15 transition-colors duration-200 cursor-default">✂️ Haircut &amp; Styling — 60 min — 150 AED</div>
              <div className="bg-white/10 rounded-lg px-4 py-3 text-sm text-slate-200 font-medium hover:bg-white/15 transition-colors duration-200 cursor-default">💅 Manicure — 45 min — 80 AED</div>
      ...
      <section id="how-it-works" className="py-24 bg-slate-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: <IconUserPlus />,    step: "01", title: "Sign up",              desc: "Create your account with your business name. No payment required to start." },
              { icon: <IconSettingsGear />, step: "02", title: "Add services & hours", desc: "List your services with prices, and set your opening hours. Takes about 2 minutes." },
              { icon: <IconShare />,        step: "03", title: "Share your link",      desc: "Copy your booking URL and add it to Google My Business, Instagram, or WhatsApp. Done." },
            ].map((item, i) => (
              <RevealOnScroll key={item.step} delay={i * 110} className="h-full">
      ...
      <section id="features" className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: <IconCalendar />,  title: "Customers book 24/7",       desc: "Your booking page is always open. Customers pick a time and confirm — no calls back and forth." },
              { icon: <IconNoFee />,     title: "Zero platform fees",         desc: "Customers pay you in person. We don't touch the money, so we don't take a cut." },
              { icon: <IconPhone />,     title: "Works on any device",        desc: "The customer booking page looks great on mobile. Most of your customers will book from their phone." },
              { icon: <IconMail />,      title: "Email confirmations",        desc: "Customers get an automatic confirmation email when they book. You get notified too." },
              { icon: <IconClock />,     title: "Real-time availability",     desc: "The calendar only shows open time slots. No double bookings, no confusion." },
              { icon: <IconDashboard />, title: "Simple admin dashboard",     desc: "See all your bookings in one place. Update status, manage services, adjust your hours." },
            ].map((f, i) => (
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
            ...
            <RevealOnScroll delay={0} className="h-full">
              <div className="pricing-card h-full bg-white rounded-2xl border border-slate-200 p-8 shadow-sm flex flex-col">
                <div className="mb-6">
                ...
                <ul className="space-y-3 mb-8 flex-1">
                  {["Unlimited bookings", "Email confirmations", "Public booking page", "Admin dashboard", "No credit card needed"].map((f) => (
                ...
                <Link href="/auth/signup" className="btn-shimmer block text-center border-2 border-emerald-600 text-emerald-700 font-semibold py-3 rounded-xl hover:bg-emerald-50">
                  Start Free
                </Link>
              </div>
            </RevealOnScroll>
            ...
            <RevealOnScroll delay={150} className="h-full">
              <div className="pricing-card pricing-card-pro h-full bg-slate-900 text-white rounded-2xl p-8 shadow-xl relative overflow-hidden flex flex-col">
                <div className="absolute top-0 right-0 bg-emerald-500 text-slate-900 text-xs font-bold px-3 py-1.5 rounded-bl-xl">POPULAR</div>
                <div className="mb-6">
                ...
                <ul className="space-y-3 mb-8 flex-1">
                  {["Unlimited bookings", "Up to 3 locations", "Priority email support", "Everything in Starter", "Arabic language (coming soon)"].map((f) => (
                ...
                <Link href="/auth/signup" className="btn-shimmer block text-center bg-emerald-500 hover:bg-emerald-400 text-slate-900 font-bold py-3 rounded-xl">
                  Start Free Trial
                </Link>
              </div>
            </RevealOnScroll>
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6">
          ...
          <RevealOnScroll delay={100}>
            <div className="divide-y divide-slate-200 rounded-2xl border border-slate-200 bg-slate-50 px-6">
              <FaqItem q="Is there a setup fee?" a="No. You can sign up and start using 7jwzat for free — no credit card required. Paid plans are optional and only needed when you want additional locations or priority support." />
              <FaqItem q="Can customers pay online through 7jwzat?" a="Not currently. Customers book their appointment through your page, then pay you in person at the time of their visit. This keeps things simple and means we never take a percentage of your revenue." />
              <FaqItem q="How many bookings can I take?" a="Unlimited. There are no booking caps on any plan — take as many appointments as your schedule allows." />
              <FaqItem q="What if I need to cancel my subscription?" a="You can cancel anytime from your account settings. No questions, no cancellation fees. Your data stays available until the end of your billing period." />
              <FaqItem q="Do you support Arabic?" a="Arabic interface is on the roadmap and coming soon. For now, 7jwzat is in English only. Customer-facing booking pages can be set up with Arabic service names." />
              <FaqItem q="Which countries do you support?" a="Currently UAE, Saudi Arabia, and Jordan. We're actively expanding to more countries in the region — contact us if yours isn't listed." />
              <FaqItem q="How do customers find my booking page?" a="You get a unique URL like yourdomain.com/book/yourbusiness. Share it on Google My Business, Instagram bio, WhatsApp, or anywhere else you promote your business." />
              <FaqItem q="Is there customer support?" a="Yes. Email support is included on all plans. Pro plan users get priority responses. Reach us at support@7jwzat.com." />
            </div>
          </RevealOnScroll>
        </div>
      </section>
