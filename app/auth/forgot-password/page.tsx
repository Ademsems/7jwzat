      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-md">
        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">{t("fp.email")}</label>
              <input
                type="email"
                required
                value={email}
            ...
            <p className="text-center text-sm text-gray-500">
              <Link href="/auth/login" className="text-emerald-600 hover:underline">{t("fp.backToLogin")}</Link>
            </p>
          </form>
        )}
      </div>
